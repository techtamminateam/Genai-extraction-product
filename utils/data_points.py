...
def personal_boat_points():
    fields = [
        ...
        'Uninsured Boater Property Damage',
        'Medical Payments',
        'Comprehensive',
        'Collision',
        'Coastal Navigation',
        'Boat or Watercraft Info',
        'Driver Info',
        'Deductible',
        'Terrorism',
        'Exclusions',
...
def professional_liability_points():
    fields = [
        'Name Insured',
        'Other Named Insured',
        'Additional Insured',
...
def pollution_liability_points():
    fields = [
        'Name Insured',
        'Other Named Insured',
        'Additional Insured',
