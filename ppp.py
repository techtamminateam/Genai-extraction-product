...
# LangChain / Gemini / FAISS (unchanged)
...
def main(file_path, business, data_points_map, prompt_map):
    ...
    if pdf_tokens > 40000:
        ...
        docs = retriever.invoke("insurance policy document")
...
if __name__ == "__main__":
    from utils.data_points import (
        ...
        personal_boat_points,
        liqour_liability_points,
        surety_bond_points,
        professional_liability_points,
        pollution_liability_points,
        personal_liability_points,
        farm_liability_points,
        garage_liability_points,
        homeowners_points,
        personal_auto_points,
        personal_umbrella_points,
        inland_marine_points,
        master_package_points
    )
    from utils.queryy import (
        ...
        prompt_umbrella,
        prompt_master_bop,
        prompt_personal_boat,
        prompt_liqour_liabilty,
        prompt_surety_bond,
        prompt_professional_liability,
        prompt_pollution_liability,
        prompt_personal_liability,
        prompt_farm_liability,
        prompt_garage_liability,
        prompt_homeowners,
        prompt_personal_auto,
        prompt_personal_umbrella,
        prompt_inland_marine,
        prompt_master_pkg
    )

    content_folder = "Farm Liability"  # Change as needed
    business = "farm_liability"  # Change as needed
    ...
    prompt_map = {
        ...
        "personal_boat" : prompt_personal_boat,
        "liqour_liability" : prompt_liqour_liabilty,
        "surety_bond" : prompt_surety_bond,
        "professional_liability" : prompt_professional_liability,
        "pollution_liability" : prompt_pollution_liability,
        "personal_liability" : prompt_personal_liability,
        "farm_liability" : prompt_farm_liability,
        "garage_liability" : prompt_garage_liability,
        "home_owners" : prompt_homeowners,
        "personal_auto" : prompt_personal_auto,
        "personal_umbrella" : prompt_personal_umbrella,
        "inland_marine" : prompt_inland_marine,
        "master_pkg" : prompt_master_pkg
    }
    ...
    data_points_map = {
        ...
        "personal_boat" : personal_boat_points,
        "liqour_liability" : liqour_liability_points,
        "surety_bond" : surety_bond_points,
        "professional_liability" : professional_liability_points,
        "pollution_liability" : pollution_liability_points,
        "personal_liability" : personal_liability_points,
        "farm_liability" : farm_liability_points,
        "garage_liability" : garage_liability_points,
        "home_owners" : homeowners_points,
        "personal_auto" : personal_auto_points,
        "personal_umbrella" : personal_umbrella_points,
        "inland_marine" : inland_marine_points,
        "master_pkg" : master_package_points
    }
